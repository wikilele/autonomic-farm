...
main-default: main.cpp default-inputvector
	g++ -o $(BUILD_DIR)/main-default main.cpp $(BUILD_DIR)/$(DEFAULT_VEC).o $(COMPILER_FALGS) $(DEBUG_FLAG)

main-updown: main.cpp updown-inputvector
	g++ -o $(BUILD_DIR)/main-updown main.cpp $(BUILD_DIR)/$(UPDOWN_VEC).o $(COMPILER_FALGS) $(DEBUG_FLAG)

main-halfdefault: main.cpp halfdefault-inputvector
	g++ -o $(BUILD_DIR)/main-halfdefault main.cpp $(BUILD_DIR)/$(HALFDEFAULT_VEC).o $(COMPILER_FALGS) $(DEBUG_FLAG)

main-constant:  main.cpp constant-inputvector
	g++ -o $(BUILD_DIR)/main-constant main.cpp $(BUILD_DIR)/$(CONSTANT_VEC).o $(COMPILER_FALGS) $(DEBUG_FLAG)

main-highlow: main.cpp highlow-inputvector
	g++ -o $(BUILD_DIR)/main-highlow main.cpp $(BUILD_DIR)/$(HIGHLOW_VEC).o $(COMPILER_FALGS) $(DEBUG_FLAG)

main-lowhigh: main.cpp lowhigh-inputvector
	g++ -o $(BUILD_DIR)/main-lowhigh main.cpp $(BUILD_DIR)/$(LOWHIGH_VEC).o $(COMPILER_FALGS) $(DEBUG_FLAG)
...
ffmain-default: ffmain.cpp default-inputvector
	g++ -o $(BUILD_DIR)/ffmain-default ffmain.cpp $(BUILD_DIR)/$(DEFAULT_VEC).o $(COMPILER_FALGS) $(FFFLAGS) $(DEBUG_FLAG)

ffmain-constant:  ffmain.cpp constant-inputvector
	g++ -o $(BUILD_DIR)/ffmain-constant main.cpp $(BUILD_DIR)/$(CONSTANT_VEC).o $(COMPILER_FALGS) $(FFFLAGS) $(DEBUG_FLAG)
